...
import { getTopicTag, TOPIC_TAGS } from '@/lib/bills'
import { getBillInterestMatchScore, getDisplayInterestKeywords } from '@/lib/interests'
import { Bill } from '@/lib/types'

export default function HomePageClient({ bills }: { bills: Bill[] }) {
  ...
  const interestKeywords = useMemo(
    () => getDisplayInterestKeywords(userInterests.customText),
